...
;(function() {
  ...
  // console.log({dx: diffX, dy: diffY, event: event})
      ...
      ResizeHandler.prototype.constraintToBox = function (diffX, diffY, flag, pointCoordsY) {
          ...
          // set min range
          var width = this.parameters.box.width + diffX;
          var height = this.parameters.box.height + diffY;
  
          if (width < c.minWidth) {
              diffX = c.minWidth - this.parameters.box.width;
          }
          if (height < c.minHeight) {
              diffY = c.minHeight - this.parameters.box.height;
          }
